# Plugin **TaHomaLocal**
<img src="[/docs/img/TaHomaLocal-Image.png](https://github.com/Eridani78/TaHomaLocal-Doc/docs/img/TaHomaLocal-Image.png)" alt="Image Logo plugin" style="height: 40%; width:40%;"/>
